...
- **NFR-001**: Define the verification evidence required for this feature
  (automated tests, static checks, and any manual validation).
- **NFR-002**: Document any security, privacy, or input-validation constraints
  introduced or affected by the feature.
- **NFR-003**: Document any new dependency, storage, or integration choice and why
  a simpler option is insufficient.
