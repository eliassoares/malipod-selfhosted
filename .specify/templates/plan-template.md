...
- **Base Branch**: `main`
- **Working Branch**: `[###-feature-name]` created from `main`
...
directories captured above; if the default tree is wrong, replace it with the
actual repository layout such as `app/` and `tests/`]
