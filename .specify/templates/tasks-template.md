...
- [ ] T001 Create feature branch from `main` and confirm branch name matches the feature
...
- [ ] TXXX [P] Additional unit/integration checks required by constitution in tests/
- [ ] TXXX Security hardening
- [ ] TXXX Run quickstart.md validation
- [ ] TXXX Prepare PR summary with implemented scope, verification evidence, and follow-ups
...
- Include file paths and the concrete verification command for any non-trivial task
