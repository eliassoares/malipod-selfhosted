...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "player.empty_title": "No episode selected",
        "player.empty_subtitle": "Start from an episode or playlist",
        "player.progress": "Progress",
        "player.rewind_15": "Rewind 15s",
        "player.forward_30": "Forward 30s",
        "player.play": "Play",
        "player.pause": "Pause",
        "playlists.manage_title": "Your playlists",
        "playlists.manage_subtitle": (
            "Create and manage playlists of episodes you want to listen to."
        ),
        "playlists.create": "Create playlist",
        "playlists.play": "Play",
        "playlists.create_title": "Create playlist",
        "playlists.edit_title": "Edit playlist",
        "playlists.delete_title": "Delete playlist",
        "playlists.delete_description": "This action is irreversible. Delete",
        "playlists.delete_confirm": "Delete",
        ...
        "playlists.success_created": "Playlist created.",
        "playlists.success_updated": "Playlist updated.",
        "playlists.success_deleted": "Playlist deleted.",
        "playlists.error_invalid_title": "Enter a valid playlist name.",
        "playlists.error_invalid_description": (
            "Description must be 1024 characters or less."
        ),
        "playlists.error_title_conflict": (
            "You already have a playlist with that name."
        ),
        "playlists.error_image_too_large": "Image must be 1MB or less.",
        "playlists.error_invalid_image": "Upload a valid image file.",
        "playlists.error_playlist_not_found": "Playlist not found.",
        "playlists.error_missing_confirmation": "Confirmation required.",
        "playlists.error_invalid_action": "Invalid action.",
        "playlists.success_episode_added": "Episode added to playlist.",
        "playlists.success_episode_removed": "Episode removed from playlist.",
        "playlists.back": "Back to playlists",
        "playlists.total": "Total",
        "playlists.episodes_in_playlist": "Episodes in playlist",
        "playlists.search_placeholder": "Search episodes",
        "playlists.search_results": "Search results",
        "playlists.add": "Add",
        "playlists.remove": "Remove",
        "playlists.empty_search": "No matching episodes.",
        "playlists.empty_playlist": "No episodes in this playlist yet.",
        ...
        "episode_detail.progress": "Progress",
        "episode_detail.total_time": "Total",
        "episode_detail.watched_time": "Watched",
        "episode_detail.download": "Download",
        "episode_detail.share": "Share",
        "episode_detail.add_to_playlist": "Add to playlist",
        "episode_detail.add_to_playlist_title": "Add to playlists",
        "episode_detail.add_to_playlist_confirm": "Add",
        "episode_detail.no_playlists": "Create a playlist to add this episode.",
        "episode_detail.go_to_playlists": "Manage playlists",
        "episode_detail.favorite": "Favorite",
        "episode_detail.unfavorite": "Unfavorite",
        "episode_detail.of": "of",
        "episode_detail.plays_count": "plays",
        "episode_detail.first_play": "first play",
        "episode_detail.last_play": "last play",
        "episode_detail.favorited_on": "favorited on",
        "episode_detail.history_title": "Listening history",
        "episode_detail.history_empty": "No listening history yet.",
        "stats.title": "Your metrics",
        "stats.subtitle": "See highlights and rankings across your podcasts.",
        "stats.total_time_listened": "Content completed",
        "stats.total_completed_episodes": "Completed episodes",
        "stats.total_followed_podcasts": "Followed podcasts",
        "stats.top_by_time": "Top podcasts by time",
        "stats.top_by_completed": "Top podcasts by completed",
        "stats.empty_rankings": "Not enough data yet.",
        "stats.temporal_title": "Temporal insights",
        "stats.temporal_placeholder": (
            "Coming soon: hours per month, preferred hour, active weekday, streak."
        ),
        ...
        "podcast_detail.stats_completion_rate": "completion rate",
        "podcast_detail.stats_in_progress": "in progress",
        "podcast_detail.stats_last_played": "last episode listened",
    ...
    "es": {
        ...
        "player.empty_title": "Ningún episodio seleccionado",
        "player.empty_subtitle": "Inicia desde un episodio o una lista",
        "player.progress": "Progreso",
        "player.rewind_15": "Rebobinar 15 s",
        "player.forward_30": "Avanzar 30 s",
        "player.play": "Reproducir",
        "player.pause": "Pausar",
        "playlists.manage_title": "Tus playlists",
        "playlists.manage_subtitle": "Crea y administra playlists de episodios.",
        "playlists.create": "Crear playlist",
        "playlists.play": "Reproducir",
        "playlists.create_title": "Crear playlist",
        "playlists.edit_title": "Editar playlist",
        "playlists.delete_title": "Eliminar playlist",
        "playlists.delete_description": "Esta acción es irreversible. Eliminar",
        "playlists.delete_confirm": "Eliminar",
        ...
        "playlists.success_created": "Playlist creada.",
        "playlists.success_updated": "Playlist actualizada.",
        "playlists.success_deleted": "Playlist eliminada.",
        "playlists.error_invalid_title": "Ingresa un nombre válido.",
        "playlists.error_invalid_description": (
            "La descripción debe tener 1024 caracteres o menos."
        ),
        "playlists.error_title_conflict": "Ya existe una playlist con ese nombre.",
        "playlists.error_image_too_large": "La imagen debe ser de 1MB o menos.",
        "playlists.error_invalid_image": "Sube una imagen válida.",
        "playlists.error_playlist_not_found": "Playlist no encontrada.",
        "playlists.error_missing_confirmation": "Se requiere confirmación.",
        "playlists.error_invalid_action": "Acción inválida.",
        "playlists.success_episode_added": "Episodio agregado a la playlist.",
        "playlists.success_episode_removed": "Episodio eliminado de la playlist.",
        "playlists.back": "Volver a playlists",
        "playlists.total": "Total",
        "playlists.episodes_in_playlist": "Episodios en la playlist",
        "playlists.search_placeholder": "Buscar episodios",
        "playlists.search_results": "Resultados de búsqueda",
        "playlists.add": "Agregar",
        "playlists.remove": "Quitar",
        "playlists.empty_search": "No hay episodios que coincidan.",
        "playlists.empty_playlist": "Aún no hay episodios en esta playlist.",
        ...
        "episode_detail.progress": "Progreso",
        "episode_detail.total_time": "Total",
        "episode_detail.watched_time": "Visto",
        "episode_detail.download": "Descargar",
        "episode_detail.share": "Compartir",
        "episode_detail.add_to_playlist": "Agregar a playlist",
        "episode_detail.add_to_playlist_title": "Agregar a playlists",
        "episode_detail.add_to_playlist_confirm": "Agregar",
        "episode_detail.no_playlists": (
            "Crea una playlist para agregar este episodio."
        ),
        "episode_detail.go_to_playlists": "Administrar playlists",
        "episode_detail.favorite": "Favorito",
        "episode_detail.unfavorite": "Quitar favorito",
        "episode_detail.of": "de",
        "episode_detail.plays_count": "reproducciones",
        "episode_detail.first_play": "primer play",
        "episode_detail.last_play": "último play",
        "episode_detail.favorited_on": "marcado favorito en",
        "episode_detail.history_title": "Historial de escuchas",
        "episode_detail.history_empty": "Aún no hay historial.",
        "stats.title": "Tus métricas",
        "stats.subtitle": "Mira destacados y rankings de tus podcasts.",
        "stats.total_time_listened": "Contenido completado",
        "stats.total_completed_episodes": "Episodios completados",
        "stats.total_followed_podcasts": "Podcasts seguidos",
        "stats.top_by_time": "Top por tiempo",
        "stats.top_by_completed": "Top por completados",
        "stats.empty_rankings": "Aún no hay datos suficientes.",
        "stats.temporal_title": "Insights temporales",
        "stats.temporal_placeholder": (
            "Pronto: horas por mes, hora preferida, día más activo y racha."
        ),
        "episode_detail.download_unavailable": (
        ...
        "podcast_detail.stats_completion_rate": "tasa de finalización",
        "podcast_detail.stats_in_progress": "en progreso",
        "podcast_detail.stats_last_played": "último episodio escuchado",
    ...
    "pt-BR": {
        ...
        "player.empty_title": "Nenhum episódio selecionado",
        "player.empty_subtitle": "Inicie por um episódio ou playlist",
        "player.progress": "Progresso",
        "player.rewind_15": "Voltar 15s",
        "player.forward_30": "Avançar 30s",
        "player.play": "Reproduzir",
        "player.pause": "Pausar",
        "playlists.manage_title": "Minhas playlists",
        "playlists.manage_subtitle": (
            "Crie e gerencie playlists de episódios que você quer ouvir."
        ),
        "playlists.create": "Criar playlist",
        "playlists.play": "Reproduzir",
        "playlists.create_title": "Criar playlist",
        "playlists.edit_title": "Editar playlist",
        "playlists.delete_title": "Apagar playlist",
        "playlists.delete_description": "Essa ação é irreversível. Apagar",
        "playlists.delete_confirm": "Apagar",
        "playlists.cancel": "Cancelar",
        ...
        "playlists.edit": "Editar",
        "playlists.delete": "Apagar",
        "playlists.success_created": "Playlist criada.",
        "playlists.success_updated": "Playlist atualizada.",
        "playlists.success_deleted": "Playlist apagada.",
        "playlists.error_invalid_title": "Informe um nome válido para a playlist.",
        "playlists.error_invalid_description": (
            "A descrição precisa ter no máximo 1024 caracteres."
        ),
        "playlists.error_title_conflict": "Você já tem uma playlist com esse nome.",
        "playlists.error_image_too_large": "A imagem precisa ter no máximo 1MB.",
        "playlists.error_invalid_image": "Envie um arquivo de imagem válido.",
        "playlists.error_playlist_not_found": "Playlist não encontrada.",
        "playlists.error_missing_confirmation": "Confirmação obrigatória.",
        "playlists.error_invalid_action": "Ação inválida.",
        "playlists.success_episode_added": "Episódio adicionado à playlist.",
        "playlists.success_episode_removed": "Episódio removido da playlist.",
        "playlists.back": "Voltar para playlists",
        "playlists.total": "Total",
        "playlists.episodes_in_playlist": "Episódios na playlist",
        "playlists.search_placeholder": "Pesquisar episódios",
        "playlists.search_results": "Resultados da pesquisa",
        "playlists.add": "Adicionar",
        "playlists.remove": "Remover",
        "playlists.empty_search": "Nenhum episódio encontrado.",
        "playlists.empty_playlist": "Nenhum episódio nessa playlist ainda.",
        "podcast_detail.website": "Website",
        "podcast_detail.by_author": "por",
        ...
        "episode_detail.progress": "Progresso",
        "episode_detail.total_time": "Total",
        "episode_detail.watched_time": "Assistido",
        "episode_detail.download": "Baixar",
        "episode_detail.share": "Compartilhar",
        "episode_detail.add_to_playlist": "Adicionar à playlist",
        "episode_detail.add_to_playlist_title": "Adicionar às playlists",
        "episode_detail.add_to_playlist_confirm": "Adicionar",
        "episode_detail.no_playlists": (
            "Crie uma playlist para adicionar este episódio."
        ),
        "episode_detail.go_to_playlists": "Gerenciar playlists",
        "episode_detail.favorite": "Favoritar",
        "episode_detail.unfavorite": "Remover favorito",
        "episode_detail.of": "de",
        "episode_detail.plays_count": "Vezes reproduzido",
        "episode_detail.first_play": "Primeiro play",
        "episode_detail.last_play": "Último play",
        "episode_detail.favorited_on": "Favoritado em",
        "episode_detail.history_title": "Histórico de ouvidas",
        "episode_detail.history_empty": "Nenhum histórico ainda.",
        "stats.title": "Minhas métricas",
        "stats.subtitle": "Veja destaques e rankings dos seus podcasts.",
        "stats.total_time_listened": "Conteúdo concluído",
        "stats.total_completed_episodes": "Episódios concluídos",
        "stats.total_followed_podcasts": "Podcasts seguidos",
        "stats.top_by_time": "Top por tempo ouvido",
        "stats.top_by_completed": "Top por concluídos",
        "stats.empty_rankings": "Ainda não há dados suficientes.",
        "stats.temporal_title": "Insights temporais",
        "stats.temporal_placeholder": (
            "Em breve: horas por mês, horário preferido, dia mais ativo e streak."
        ),
        "episode_detail.download_unavailable": (
        ...
        "podcast_detail.stats_completion_rate": "Taxa de conclusão",
        "podcast_detail.stats_in_progress": "Em progresso",
        "podcast_detail.stats_last_played": "Último episódio ouvido",
